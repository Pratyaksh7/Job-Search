...
<div class="row">
    ...
    <div class="col-md-8 pt-5">
        <div class="container">
            ...
            <h4><?= anchor('opportunity/job_id/'.$job->job_id, $job->name,['class'=>' btn-link', 'style'=>'color: #428bca; font-family: Bell MT;']); ?></h4>

            <?= form_open("opportunity/submit_resumes/{$job->job_id}"); ?>
