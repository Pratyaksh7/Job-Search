...
<html>
<head>
<title>ndimensionstudio | Admin Panel</title>
              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-column">
                  <a href="#" class="d-flex align-items-center border-bottom pb-3">
                    <div class="mr-3">
                      <img src="<?= base_url(); ?>assets/images/faces/face2.jpg" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                  ...
                  <a href="#" class="d-flex align-items-center border-bottom py-3">
                    <div class="mr-3">
                      <img src="<?= base_url(); ?>assets/images/faces/face3.jpg" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                  ...
                  <a href="#" class="d-flex align-items-center border-bottom py-3">
                    <div class="mr-3">
                      <img src="<?= base_url(); ?>assets/images/faces/face4.jpg" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                  ...
                  <a href="#" class="d-flex align-items-center border-bottom py-3">
                    <div class="mr-3">
                      <img src="<?= base_url(); ?>assets/images/faces/face5.jpg" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                  ...
                  <a href="#" class="d-flex align-items-center border-bottom py-3">
                    <div class="mr-3">
                      <img src="<?= base_url(); ?>assets/images/faces/face6.jpg" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
